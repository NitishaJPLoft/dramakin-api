...
import SpotifyForGuest from './SpotifyForGuest';
 ...
 */
class SpotifyControllerForGuest {
    req: Request;
    res: Response;
    next: NextFunction;
    ...
    search = async () => {
        try {
            ...
            const result = await SpotifyForGuest.search(
                query,
                access_token,
                limit,
                offset
...
export default SpotifyControllerForGuest;
